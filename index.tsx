    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm text-slate-400">
          {['Academic Calendar', 'Fee Structure', 'Transport', 'Scholarships', 'Board Results'].map(item => (
...
const HomePage = ({ onNavigate, onReadArticle }: { onNavigate: (p: Page) => void, onReadArticle: (a: Article) => void }) => {
  const articles: Article[] = [
    {
      ...
      content: "The robotics club at Babu Ji School has achieved a new milestone by creating a fully functional AI-driven waste segregator. This project aims to promote sustainability on campus while providing students with hands-on experience in machine learning and hardware engineering."
    },
    {
      image: "https://images.unsplash.com/photo-1461896704190-32111b79e94a?auto=format&fit=crop&q=80&w=1200",
      title: "Annual Sports Carnival Highlights",
      date: "May 12, 2024",
      desc: "Celebrating 3 days of athleticism, team spirit, and incredible performances.",
      content: "The Annual Sports Carnival 2024 saw unprecedented participation across all houses. From track and field events to competitive chess matches, students displayed remarkable sportsmanship. Red House emerged as the overall champions this year."
    },
    {
      image: "https://images.unsplash.com/photo-1507842217343-583bb7270b66?auto=format&fit=crop&q=80&w=1200",
      title: "Library Expansion Phase 2 Complete",
      date: "April 28, 2024",
      desc: "Our digital library now hosts over 50,000+ e-resources for deep research.",
      content: "We are proud to announce the completion of our library expansion. The new wing features ergonomic study pods, a dedicated multimedia zone, and state-of-the-art research workstations for senior students."
    }
  ];
            ...
            <div key={i} className="bg-white rounded-[32px] overflow-hidden shadow-sm border border-slate-100 group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <button 
                  ...
                  className="text-blue-900 font-bold text-sm flex items-center gap-2 group/btn hover:translate-x-1 transition-transform"
                >
    ...
    <section className="flex flex-col md:flex-row items-center gap-16">
      <div className="flex-1 space-y-8">
        ...
        <div className="grid grid-cols-2 gap-8 pt-4">
          <div>
            <div className="text-4xl font-bold text-blue-900 mb-1">98.4%</div>
            <div className="text-slate-500 text-sm">Board Exam Average</div>
          </div>
          <div>
            <div className="text-4xl font-bold text-blue-900 mb-1">1:15</div>
            <div className="text-slate-500 text-sm">Teacher-Student Ratio</div>
          </div>
        </div>
      </div>
    ...
    <section className="grid md:grid-cols-2 gap-20 items-center">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          {[
            { title: 'Academic Rigor', desc: 'Comprehensive curriculum following CBSE/International standards.' },
            { title: 'Ethical Values', desc: 'Instilling integrity and social responsibility in every student.' },
            { title: 'Global Outlook', desc: 'Preparing students for international higher education opportunities.' }
          ].map((item, idx) => (
...
const GalleryPage = () => {
  ...
  const images = [
    { url: 'https://images.unsplash.com/photo-1523240715634-d1c6511406bd?auto=format&fit=crop&q=80&w=800', category: 'Academic', title: 'Student Discussion' },
    { url: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&q=80&w=800', category: 'Academic', title: 'Chemistry Lab' },
    { url: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?auto=format&fit=crop&q=80&w=800', category: 'Academic', title: 'Library Hour' },
    { url: 'https://images.unsplash.com/photo-1461896704190-32111b79e94a?auto=format&fit=crop&q=80&w=800', category: 'Sports', title: 'Track & Field' },
    { url: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&q=80&w=800', category: 'Cultural', title: 'Art Workshop' },
    { url: 'https://images.unsplash.com/photo-1540317580114-ed684c15ffcc?auto=format&fit=crop&q=80&w=800', category: 'Cultural', title: 'Theater Rehearsal' },
    { url: 'https://images.unsplash.com/photo-1529390079861-591de354faf5?auto=format&fit=crop&q=80&w=800', category: 'Sports', title: 'Football Training' },
    { url: 'https://images.unsplash.com/photo-1571260899304-425eee4c7efc?auto=format&fit=crop&q=80&w=800', category: 'Campus', title: 'School Assembly' },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-24">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg">Glimpses into the everyday magic at Babu Ji School.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredImages.map((img, i) => (
          <div key={i} className="group relative h-96 overflow-hidden rounded-[40px] cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-700">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-blue-900/90 via-blue-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-10 text-white">
    ...
    <div className="min-h-[90vh] flex items-center justify-center px-4 py-24 bg-slate-50 relative overflow-hidden">
      <div className="bg-white w-full max-w-md rounded-[40px] shadow-2xl overflow-hidden border border-slate-100 relative z-10">
        <div className="bg-blue-900 p-12 text-center text-white relative">
          ...
          <h2 className="text-3xl font-bold mb-2">{type === 'login' ? 'Welcome Back' : 'Join Our School'}</h2>
          <p className="text-blue-200 text-sm font-light">{type === 'login' ? 'Enter your credentials to proceed' : 'Create your admission profile today'}</p>
        </div>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="p-10 space-y-6">
            {type === 'signup' && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input required type="text" className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-4 text-sm focus:ring-2 focus:ring-blue-900 outline-none transition-all" placeholder="Rohan" />
                </div>
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1">Last Name</label>
                  <input required type="text" className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-4 text-sm focus:ring-2 focus:ring-blue-900 outline-none transition-all" placeholder="Sharma" />
                </div>
              </div>
            )}
            <div>
              <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1">Email ID</label>
              <input required type="email" className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-4 text-sm focus:ring-2 focus:ring-blue-900 outline-none transition-all" placeholder="name@domain.com" />
            </div>
            <div>
              <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1">Password</label>
              <input required type="password" name="password" className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-4 text-sm focus:ring-2 focus:ring-blue-900 outline-none transition-all" placeholder="••••••••" />
            </div>
            <button 
              type="submit"
              disabled={loading}
              className="w-full bg-blue-900 hover:bg-blue-800 disabled:opacity-70 text-white font-black py-5 rounded-[20px] shadow-xl transition-all active:scale-95 text-sm uppercase tracking-widest flex justify-center items-center gap-2"
            >
              {loading ? (
            ...
            <div className="text-center">
              ...
              >
                {type === 'login' ? "New student? Apply here" : "Already applied? Log in"}
              </button>
            </div>
          </form>
        )}
...
const ArticleViewer = ({ article, onClose }: { article: Article, onClose: () => void }) => (
  <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
    <div className="bg-white w-full max-w-4xl max-h-[90vh] rounded-[40px] overflow-hidden shadow-2xl flex flex-col animate-in zoom-in-95 duration-300">
      <div className="relative h-72 shrink-0">
        <img src={article.image} className="w-full h-full object-cover" alt={article.title} />
        <button 
          onClick={onClose}
          className="absolute top-6 right-6 bg-white/20 backdrop-blur-md hover:bg-white/40 text-white p-3 rounded-full transition-all"
        >
          <X size={24} />
        </button>
      </div>
      <div className="p-10 overflow-y-auto custom-scrollbar">
        <div className="flex items-center gap-4 mb-6">
          <span className="bg-blue-900 text-white text-[10px] font-black uppercase tracking-widest px-4 py-1 rounded-full">{article.date}</span>
          <div className="h-px bg-slate-200 flex-grow" />
        </div>
        <h2 className="text-4xl font-bold text-slate-900 mb-6 leading-tight">{article.title}</h2>
        <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-4">
          <p className="text-lg font-medium text-slate-900">{article.desc}</p>
          <p>{article.content}</p>
          <p>This is a developing story from Babu Ji School Media Center. For more details on our events, please follow our official social handles or contact the department head.</p>
        </div>
      </div>
    </div>
  </div>
...
const AIAssistant = ({ onNavigate }: { onNavigate: (page: Page) => void }) => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: 'Namaste! I am the Babu Ji School Guide. I can help with information or navigate you to our Gallery, About Us, or Enrollment pages.' }
  ]);
    ...
    try {
      ...
      const sessionPromise = ai.live.connect({
            ...
            if (message.toolCall) {
              for (const fc of message.toolCall.functionCalls) {
                if (fc.name === 'navigateToPage') {
                  ...
                  onNavigate(target);
                  const result = `Navigated to ${target}.`;
        ...
        config: {
          ...
          systemInstruction: 'You are the Babu Ji Guide. Help users explore the school website. Use function calls for navigation.'
        }
      });
    ...
    try {
      ...
      if (!chatSessionRef.current) {
        chatSessionRef.current = ai.chats.create({
          ...
          config: {
            tools: [{ functionDeclarations: [navigateToPageDeclaration] }],
            systemInstruction: `You are the Babu Ji School Assistant. You can navigate the user to home, about, gallery, login, signup using tools.`
          }
        });
      }
      ...
      if (response.functionCalls) {
        for (const fc of response.functionCalls) {
          if (fc.name === 'navigateToPage') {
            const target = (fc.args as any).page as Page;
            onNavigate(target);
            setMessages(prev => [...prev, { role: 'assistant', content: `Certainly! Moving you to the ${target} page.` }]);
          }
        }
      } else {
        setMessages(prev => [...prev, { role: 'assistant', content: response.text || "I am here to help." }]);
      }
    } catch (err) {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[60]">
      {isOpen ? (
        <div className="bg-white w-[380px] md:w-[420px] h-[600px] rounded-[40px] chat-shadow flex flex-col overflow-hidden animate-in zoom-in-95 duration-300 origin-bottom-right border border-slate-200">
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] text-blue-200 uppercase font-black tracking-widest">Active Assistant</span>
                </div>
              </div>
            </div>
            <button 
              onClick={() => { cleanupVoice(); setIsOpen(false); }}
              className="hover:bg-white/10 p-2.5 rounded-full transition-colors flex items-center gap-1 group relative z-10"
            ...
            {messages.map((msg, i) => (
              <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'} animate-in slide-in-from-bottom-2 duration-300`}>
                <div className={`max-w-[85%] px-5 py-4 rounded-[24px] text-sm leading-relaxed shadow-sm ${
                  msg.role === 'user' ? 'bg-blue-900 text-white rounded-br-none' : 'bg-white border border-slate-100 text-slate-700 rounded-bl-none'
                }`}>
                  {msg.content}
                </div>
              </div>
            ...
            {isVoiceActive && (
              <div className="absolute inset-0 bg-blue-900/95 backdrop-blur-xl z-20 flex flex-col items-center justify-center text-white p-10 text-center space-y-10 animate-in fade-in duration-500">
                ...
                <div className="space-y-4">
                  <h3 className="text-2xl font-bold tracking-tight">{isSpeaking ? 'Speaking' : 'Listening...'}</h3>
                  <p className="text-blue-100/70 text-sm leading-relaxed font-light">Try saying "Take me to the Gallery".</p>
                </div>
                <button 
          ...
          {!isVoiceActive && (
            <div className="p-6 bg-white border-t border-slate-50 flex gap-3 items-center shrink-0">
              <button 
                ...
                className="bg-slate-100 text-slate-500 p-3.5 rounded-2xl hover:bg-yellow-400 hover:text-blue-900 transition-all group active:scale-90"
              >
                <Mic size={22} />
              </button>
              <div className="flex-1">
                <input 
                  ...
                  className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 text-sm outline-none focus:ring-2 focus:ring-blue-900/10 transition-all"
                />
              </div>
              <button 
                onClick={handleSend}
                className="bg-blue-900 text-white p-3.5 rounded-2xl hover:bg-blue-800 disabled:opacity-50 transition-all shadow-lg active:scale-90"
...
const App = () => {
  ...
  const renderContent = () => {
    switch (currentPage) {
      case 'home': return <HomePage onNavigate={setCurrentPage} onReadArticle={setSelectedArticle} />;
      ...
      default: return <HomePage onNavigate={setCurrentPage} onReadArticle={setSelectedArticle} />;
    }
  };
